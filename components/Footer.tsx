  ...
  return (
    <footer className="bg-dark text-white">
      <div className="container mx-auto px-6 py-12 lg:py-16">
        {/* Orange accent line */}
        <div className="w-24 h-1 bg-primary mb-12 mx-auto lg:mx-0"></div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 mb-12">
          ...
          <div className="space-y-8">
            ...
            <div className="text-center lg:text-left">
              <h3 className="text-2xl font-bold uppercase tracking-wider">audiophile</h3>
            </div>

            {/* Navigation - Mobile: Vertical, Desktop: Horizontal */}
            <nav className="flex flex-col lg:flex-row gap-4 lg:gap-8 text-center lg:text-left">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16">
          {/* Description */}
          <div className="text-center lg:text-left">
            <p className="text-white/50 leading-relaxed text-sm lg:text-base max-w-lg mx-auto lg:mx-0">
          ...
          <div className="flex flex-col lg:flex-row lg:justify-between lg:items-end gap-8">
            ...
            <div className="text-center lg:text-left lg:mt-16">
              <p className="text-white/50 text-sm font-bold">Copyright 2021. All Rights Reserved</p>
            </div>
